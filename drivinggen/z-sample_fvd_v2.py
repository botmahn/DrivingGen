...
if __name__ == '__main__':
    ...
    parser.add_argument('--metric',     type=str, default='fvd',
                        ...
                        help='Metric(s) to compute. Use "all" to run every metric, '
                             '"all_no_vlm" to run all except a_missing (skips vLLM dependency).')
    ...
    if args.metric in ('fvd', 'all', 'all_no_vlm'):
    ...
    if args.metric in ('a_consist', 'a_missing', 'all', 'all_no_vlm'):
    ...
    if args.metric in ('obj_q', 'all', 'all_no_vlm'):
    ...
    if args.metric in ('sub_q', 'all', 'all_no_vlm'):
